...
<section id="news-section">
  ...
  <div class="news-container">
    <ul class="news-list">
      <!-- 在此处插入多条新闻项 -->
      <li class="news-item">新闻标题 1 - <a href="#">阅读全文</a></li>
      <li class="news-item">新闻标题 2 - <a href="#">阅读全文</a></li>
      <li class="news-item">新闻标题 3 - <a href="#">阅读全文</a></li>
      <li class="news-item">新闻标题 4 - <a href="#">阅读全文</a></li>
      <li class="news-item">新闻标题 5 - <a href="#">阅读全文</a></li>
      <!-- ... -->
    </ul>
  </div>
</section>
